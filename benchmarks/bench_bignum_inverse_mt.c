/**
 * @file bench_bignum_inverse_mt.c
 * @brief ISO C entry point for the multi-thread bignum_inverse benchmark.
 *
 * @details
...
#include "adapter/bignum_inverse_benchmark_adapter.h"
...
int main(int argc, char **argv)
{
    ...
    bignum_inverse_benchmark_status_t adapter_status;
    benchmark_core_status_t core_status;

    adapter_status = bignum_inverse_benchmark_adapter_init(&adapter);
    if (adapter_status != BIGNUM_INVERSE_BENCHMARK_STATUS_SUCCESS) {
        return EXIT_FAILURE;
    }
